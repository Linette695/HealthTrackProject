	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener(){  
			public void actionPerformed(ActionEvent e){  
				Appointment a = new Appointment(comboBox_4.getSelectedIndex(), comboBox_4_1.getSelectedItem().toString(), comboBox.getSelectedIndex(), (int)spinner.getValue(), (int)spinner_1.getValue(), comboBox_1.getSelectedIndex(), comboBox_3.getSelectedIndex(), (int)spinner_3.getValue(), (int)spinner_1_1.getValue(), comboBox_1_1.getSelectedIndex());
